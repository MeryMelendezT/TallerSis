            ...
            <div class="col-xl-6 order-xl-2 mb-5 mb-xl-0">
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="card-body">
                            <form method="POST" action="{{ url('/updateCanino/'.$canino->id) }}" enctype="multipart/form-data">
                            @csrf
                            <!-- Description -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nombre" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre"  value="{{ $canino->nombre }}" placeholder="Nombre" pattern="[a-zA-Z ]+" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="raza" class="form-control{{ $errors->has('raza') ? ' is-invalid' : '' }}" name="raza" value="{{ $canino->raza }}" placeholder="Raza" pattern="[a-zA-Z ]+" required>
                                                @if ($errors->has('raza'))
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="nacimiento" class="form-control" name="nacimiento" placeholder="Seleccionar fecha de nacimiento" value="{{ $canino->nacimiento }}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            @elseif($canino->genero == 'Hembra')
                                                <div class="custom-control custom-radio mb-3">
                                                    <input name="genero" class="custom-control-input" id="Macho" type="radio" value="Macho">
                                                    <label class="custom-control-label" for="Macho">
                                                        <span>Macho</span>
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-radio mb-3">
                                                    <input name="genero" class="custom-control-input" id="Hembra" checked type="radio" value="Hembra">
                                                    <label class="custom-control-label" for="Hembra">
                                                        <span>Hembra</span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            @elseif($canino->agresivo == 'No')
                                                <div class="custom-control custom-radio mb-3">
                                                    <input name="agresivo" class="custom-control-input" id="Si"  type="radio" value="Si">
                                                    <label class="custom-control-label" for="Si">
                                                        <span>Si</span>
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-radio mb-3">
                                                    <input name="agresivo" class="custom-control-input" id="No" checked type="radio" value="No">
                                                    <label class="custom-control-label" for="No">
                                                        <span>No</span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="peso" class="form-control{{ $errors->has('peso') ? ' is-invalid' : '' }}" name="peso" value="{{ $canino->peso }}" placeholder="Peso de la mascota" pattern="[0-9.,]+" required>
                                                @if ($errors->has('peso'))
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="tipo_comida" name="tipo_comida" rows="4" class="form-control" placeholder="Ingrese el tipo de comida y los horarios correspondientes de su mascota...">{{ $canino->tipo_comida }}</textarea>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="extras" name="extras" rows="4" class="form-control" placeholder="Ingrese problemas medicos, alergias, miedos entre otros..." >{{ $canino->extras }}</textarea>
