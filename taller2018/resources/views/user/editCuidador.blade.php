                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="departamento" class="form-control{{ $errors->has('departamento') ? ' is-invalid' : '' }}" name="departamento" value="{{ Auth::user()->departamento }}" pattern="[a-zA-Z ]+" placeholder="Departamento" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="nacimiento" class="form-control" name="nacimiento" placeholder="Seleccionar fecha de nacimiento" value="{{ Auth::user()->nacimiento }}" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="descripcion" name="descripcion" rows="1" class="form-control" placeholder="Ingrese referencias laborales">{{ Auth::user()->descripcion }}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="trabajo" name="trabajo" rows="1" class="form-control" placeholder="Ingrese referencias laborales">{{ Auth::user()->trabajo }}</textarea>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="col-md-12">
                                            ...
                                            @elseif(Auth::user()->jardin == 'No')
                                                <div class="custom-control custom-control-inline custom-radio mb-3">
                                                    <input name="jardin" class="custom-control-input" id="jardines" type="radio" value="Si">
                                                    <label class="custom-control-label" for="jardines">
                                                        <span>Si</span>
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-control-inline custom-radio mb-3">
                                                    <input name="jardin" class="custom-control-input" id="jardin_no" checked  type="radio" value="No">
                                                    <label class="custom-control-label" for="jardin_no">
                                                        <span>No</span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="col-md-12">
                                            ...
                                            @elseif(Auth::user()->terraza == 'No')
                                                <div class="custom-control custom-control-inline custom-radio mb-3">
                                                    <input name="terraza" class="custom-control-input" id="terraza" type="radio" value="Si">
                                                    <label class="custom-control-label" for="terraza">
                                                        <span>Si</span>
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-control-inline custom-radio mb-3">
                                                    <input name="terraza" class="custom-control-input" id="terraza_no" checked type="radio" value="No">
                                                    <label class="custom-control-label" for="terraza_no">
                                                        <span>No</span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="col-md-12">
                                            ...
                                            @elseif(Auth::user()->balcon == 'No')
                                                <div class="custom-control custom-control-inline custom-radio mb-3">
                                                    <input name="balcon" class="custom-control-input" id="balcon" type="radio" value="Si">
                                                    <label class="custom-control-label" for="balcon">
                                                        <span>Si</span>
                                                    </label>
                                                </div>
                                                <div class="custom-control custom-control-inline custom-radio mb-3">
                                                    <input name="balcon" class="custom-control-input" id="balcon_no" checked type="radio" value="No">
                                                    <label class="custom-control-label" for="balcon_no">
                                                        <span>No</span>
                                                    </label>
                                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-md-12">
                                        ...
                                        @elseif(Auth::user()->tipo_casa == 'Apartamento')
                                            <div class="custom-control custom-control-inline custom-radio mb-3">
                                                <input name="tipo_casa" class="custom-control-input" id="Patio" type="radio" value="Casa Patio">
                                                <label class="custom-control-label" for="Patio">
                                                    <span>Casa Patio</span>
                                                </label>
                                            </div>
                                            <div class="custom-control custom-control-inline custom-radio mb-3">
                                                <input name="tipo_casa" class="custom-control-input" id="Apartamento" checked type="radio" value="Apartamento">
                                                <label class="custom-control-label" for="Apartamento">
                                                    <span>Apartamento</span>
                                                </label>
                                            </div>
                                        ...
                                        @elseif(Auth::user()->tipo_casa == 'Duplex')
                                            ...
                                            <div class="custom-control custom-control-inline custom-radio mb-3">
                                                <input name="tipo_casa" class="custom-control-input" id="Duplex" checked type="radio" value="Duplex">
                                                <label class="custom-control-label" for="Duplex">
                                                    <span>Duplex</span>
                                                </label>
                                            </div>
                                        ...
                                        @elseif(Auth::user()->tipo_casa == 'Chalet')
                                            ...
                                            <div class="custom-control custom-control-inline custom-radio mb-3">
                                                <input name="tipo_casa" class="custom-control-input" id="Chalet" checked type="radio" value="Chalet">
                                                <label class="custom-control-label" for="Chalet">
                                                    <span>Chalet</span>
                                                </label>
                                            </div>
